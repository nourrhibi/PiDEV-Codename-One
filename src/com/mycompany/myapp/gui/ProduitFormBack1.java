 ...
 * @author sarra
 */
public class ProduitFormBack1 extends BaseForm {

    private Form current;
ArrayList<Categorie> listcat = new ArrayList<Categorie>();
  ArrayList<Categorie> cats;
    String catt;
    public ProduitFormBack1(Resources res) {
      ...
      //  addTab(swipe, res.getImage("n-routinesport.jpg"), spacer1, "15 Likes  ", "85 Comments", "Integer ut placerat purued non dignissim neque. ");
        ...
        RadioButton all = RadioButton.createToggle("categorie Back", barGroup);
        ...
        ArrayList<Categorie> en = ServiceCat.getInstance().getAllCat();

        Display.getInstance().scheduleBackgroundTask(() -> {

            Display.getInstance().callSerially(() -> {
                for (Categorie eyy : en) {
                    //MultiButton m = new MultiButton();
                    addButton(eyy.getNom(), res,  eyy.getId(),eyy);
 ...
 Container round = new Container();
        ...
        fab.addActionListener(e -> {
           new addProduitFormBack1(res).show();
        });
    ...
    private void addButton(String nom, Resources res,  int id,Categorie t) {
        ...
        cats= ServiceCat.getInstance().getAllCat();
          ...
          FloatingActionButton delete = FloatingActionButton.createFAB(FontImage.MATERIAL_CLEAR);
           delete.addActionListener(evt -> {
                    ServiceCat.getInstance().delete(id);
        ...
        new ProduitFormBack1(res).show();
         ...
         Label Nom = new Label("Nom de categorie :"+nom);
        Nom.setUIID("NewsTopLine");
     Container box = BoxLayout.encloseX(Nom,delete);
